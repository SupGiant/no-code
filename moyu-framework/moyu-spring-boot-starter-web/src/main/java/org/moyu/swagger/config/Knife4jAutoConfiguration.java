package org.moyu.swagger.config;
...
/**
 * 增强的swagger（2015改名为OpenAPI）的knife4j自动配置类
 * @author linr
 * @since 2023/8/20 9:54
 */
@AutoConfiguration
@ConditionalOnClass({OpenAPI.class}) // 有OpenAPI类时才会生效
@EnableConfigurationProperties(SwaggerProperties.class) // 开启配置属性支持
